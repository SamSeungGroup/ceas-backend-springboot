package com.samseung.ceas.handler;
...
public class ImageHandler {
    ...
    public List<Image> parseFileUserInfo(Long imageId, List<MultipartFile> multipartFiles, UserDTO userDTO) throws Exception {
        ...
        // 경로를 지정하고 그곳에다가 저장
        String path = "src/main/resources/static/image/" + current_date;
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            ...
            if (!multipartFile.isEmpty()) {
                ...
                Image image = Image.builder()
                        ...
                        .user(userService.retrieve(userDTO.getId()))
                        .build();
                imageList.add(image);
        ...
        for (MultipartFile multipartFile : multipartFiles) {
            ...
            if (!multipartFile.isEmpty()) {
                ...
                Image image = Image.builder()
                        ...
                        .storedFileName(path + "/" + new_image_name)
                        .fileSize(multipartFile.getSize())
                        .product(productService.retrieve(productDTO.getId()))
                        .build();
                imageList.add(image);
